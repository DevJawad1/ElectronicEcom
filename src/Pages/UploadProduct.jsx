            ...
            <div className="d-flex">
                <div className="upload-box mt-4 pt-3 px-5 col-md-6">
                    ...
                    <div className="p-3 img-box px-4">
                        ...
                        <input type="file" multiple accept="image/*" onChange={handleImageChange} className='d-none' id="imageUpload" />
                ...
                <div className="col-md-6 mt-4 pt-5">
                    ...
                    <textarea name="" id="" cols="30" rows="10" className="p-1 imgs rounded d-flex align-items-center justify-content-center" style={{ height: "65vh", width: "47.5vw" }}></textarea>
                    <div className="text-center mt-3">
                        <button className='col-10 btn text-white' style={{ backgroundColor: "#0DC029", height: "50px" }}>Upload</button>
                    </div>
                </div>
