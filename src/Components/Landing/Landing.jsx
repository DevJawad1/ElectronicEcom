    ...
    <div className='d-md-flex'>
      <div className='col-12 col-md-7 px-md-3'>
        <div className='p-3'>
          ...
          <div className='col-12 d-flex gap-md-3 gap-2 mt-3 px-md-4'>
          <button className='btn col-md-2 col-3 app-theme' style={{backgroundColor:"#0DC029", height:"50px"}}> 
            <Link to={'/register'} className='text-decoration-none text-white'>Get Started</Link>
          </button>
          <button className='btn col-md-5 col-9 linear-color text-white fw-semibold'>Check for Vendors in your Area</button>
          </div>
        </div>
      </div>
      <div className='col-12 col-md-5 px-md-3 mt-5 mt-md-0 d-md-block'>
        <div className=''>
